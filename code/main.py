...
def store_processed_images(sample_name, print_i, frame1_img, cc_output, fe_output_color):
...
for i, pair in enumerate(train_pairs):
    ...
    store_processed_images(None, print_i, frame1_img, cc_output, fe_output_color)
    timer.show()