...
from models import V3Adapt, V3Correlation
...
def load_dataset(args):
    ...
    for video in tub.load_all_videos(args.data_path, load_peds=False):
        ...
        train_video.generate_frame_pairs(distance=args.frames_between)
        train_pairs += train_video.get_frame_pairs()

        val_video.generate_frame_pairs(distance=args.frames_between)
...
if __name__ == '__main__':
    ...
    args.loss_focus = 'full'  # 'cc' or 'fe' or 'full'
    args.cc_weight = 5  # equal is around 0.002
