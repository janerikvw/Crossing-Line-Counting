...
\todo{Reducing the amount of footage to create a doable benchmark, then define this here as well. Fixed-16 is used instead of fixed-8. 4 sequences are used.}
...
Due to the sparsity of the data only 20\% of the data (10\% at the start and 10\% at the end of the sequence) is used for training and the rest is used as testing. \todo{This is very sparse for training, which appears especially in IM01, what should I do? Increase the amount of training data from 20\% to 30\%??}
